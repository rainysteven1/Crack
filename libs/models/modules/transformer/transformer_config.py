...
def get_b16_config():
    ...
    config.pretrained_path = "resources/checkpoints/ViT-B_16.npz"
...
def get_b32_config():
    ...
    config.pretrained_path = "resources/checkpoints/ViT-B_32.npz"
    return config
...
def get_l16_config():
    ...
    config.classifier = "seg"
    config.pretrained_path = "resources/checkpoints/ViT-L_16.npz"
...
def get_l32_config():
    ...
    config.pretrained_path = "resources/checkpoints/ViT-L_32.npz"
    return config
